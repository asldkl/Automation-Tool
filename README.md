...
- **WeGame 账号登录** — 使用备注中的游戏账号+驱动级键盘输入自动登录，多账号自动切换
...
1. 点击「添加账号」，在弹出的账号信息设置窗口中填写游戏账号（必填）、密码、备注等信息
2. 配置 WeGame 路径
3. 勾选需要自动执行的操作
...
> **v1.1.5 更新**：WeGame 账号密码登录（驱动级键盘输入 PyDirectInput）、账号信息设置窗口、主界面四列显示（账号名称/现有资产/下次运行时间/备注）、账号序号显示、资产监测自定义天数
>
